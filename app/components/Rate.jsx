                ...
                <div className="col-sm-6 ">
                  <div className="card">
                    <div  className="card-body">
                      ...
                      <p id='litLong' className="card-text">Don't want to fly- but still want to catch all the fun? No problem. If you decide to upgrade
                ...
                <div className="col-sm-6 ">
                  <div className="card">
                    <div className="card-body">
                      ...
                      <p id='lotLong' className="card-text">Have a group of 4 people or more? We will offer a discount proportional to the number of total passengers
